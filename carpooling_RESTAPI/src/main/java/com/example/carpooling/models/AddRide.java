...
public class AddRide 
{
	...
	LocalDateTime time_and_date_of_departure,time_of_arival;
	...
	public AddRide(int id, int carowner_id, int start_location, int end_location, int vehicle_id,
			LocalDateTime time_and_date_of_departure, LocalDateTime time_of_arival, int price_per_seat, int available_seats,
			String status) {
		super();
		this.id = id;
	...
	public AddRide(int carowner_id, int start_location, int end_location, int vehicle_id,
			LocalDateTime time_and_date_of_departure, LocalDateTime time_of_arival, int price_per_seat, int available_seats,
			String status) {
		super();
		this.carowner_id = carowner_id;
